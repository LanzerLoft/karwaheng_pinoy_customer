...
class TransferBalancetoPaymaya extends StatelessWidget {
...
class TransferBalanceToPayMayaNumber extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      behavior: HitTestBehavior.opaque,
                  ...
                  () => showGeneralDialog(
                        ...
                        transitionBuilder: (context, a1, a2, child) {
                          return ScaleTransition(
                            ...
                            child: TransferPayMayaSuccessful(),
                          );
                        },
