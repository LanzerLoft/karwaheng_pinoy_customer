...
class TransferBalancetoKPWallet extends StatelessWidget {
...
class TransferBalanceToKPWalletNumber extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      behavior: HitTestBehavior.opaque,
                ...
                () => showGeneralDialog(
                      ...
                      transitionBuilder: (context, a1, a2, child) {
                        return ScaleTransition(
                          ...
                          child: TransferKPWalletSuccessful(),
                        );
                      },
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text("KP Rider Information",
