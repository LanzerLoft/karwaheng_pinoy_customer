...
class UserPabiliGcashSteps extends StatelessWidget {
  const UserPabiliGcashSteps({Key key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    }, "Copy KP Rider's GCASH Account Number", 5,
                  ...
                  Padding(
                    ...
                    }, "Go to GCash App Now", 5, double.infinity, Pallete.kpRed,
                        Pallete.kpRed),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top: 10),
                    child: customButtonGrey(() {
                      pageRoute(context,
                          UploadScreenshotGcashPabiliWithNoticeBelow2k());
...
class UploadScreenshotGcashPabiliWithNoticeBelow2k extends StatelessWidget {
  const UploadScreenshotGcashPabiliWithNoticeBelow2k({Key key})
      : super(key: key);
