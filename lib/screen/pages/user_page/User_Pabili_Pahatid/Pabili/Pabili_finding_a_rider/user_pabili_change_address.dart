...
class UserPabiliChangeAddress extends StatefulWidget {
  @override
  State<UserPabiliChangeAddress> createState() =>
      UserPabiliChangeAddressState();
}

class UserPabiliChangeAddressState extends State<UserPabiliChangeAddress> {
  @override
    ...
    return new Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: Container(
          ...
          child: FlatButton(
            onPressed: () {
              _pabilichangeAddressApply(context);
            },
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return customCardChangeAddressPahatid(
                ...
                "Pickup",
                () {
                  pageRoute(context, UserPabiliCAEditAddress());
                },
              );
            },
            itemCount: 2,
...
class UserPabiliCAEditAddress extends StatefulWidget {
  @override
  State<UserPabiliCAEditAddress> createState() =>
      UserPabiliCAEditAddressState();
}

class UserPabiliCAEditAddressState extends State<UserPabiliCAEditAddress> {
  @override
  Widget build(BuildContext context) {
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: buttonHomeWorkRecentPabiliChangeAddress(
                    context,
                    () {
                ...
                changeAddressTextFieldOntap(
                  ...
                  "Enter pickup address",
                  () {
                    pageRoute(context, UserPabiliCAEditAddressMAP());
                  },
                ),
...
class UserPabiliCAEditAddressMAP extends StatefulWidget {
  @override
  State<UserPabiliCAEditAddressMAP> createState() =>
      UserPabiliCAEditAddressMAPState();
}

class UserPabiliCAEditAddressMAPState
    extends State<UserPabiliCAEditAddressMAP> {
...
_pabilichangeAddressApply(BuildContext context) {
  showDialog(
    context: context,
    builder: (ctxt) => Dialog(
      elevation: 0,
