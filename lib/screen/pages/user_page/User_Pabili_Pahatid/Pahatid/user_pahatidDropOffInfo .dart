                  ...
                  Column(
                    children: [
                      addressPickupLocation((value) {},
                          ...
                          () {
                        pageRoute(context, PahatidEnterDropOffMAP());
                      }),
                      Align(
...
class PahatidEnterDropOffMAP extends StatefulWidget {
  @override
  State<PahatidEnterDropOffMAP> createState() => PahatidEnterDropOffMAPState();
}

class PahatidEnterDropOffMAPState extends State<PahatidEnterDropOffMAP> {
