...
class EmailNewPasscode extends StatefulWidget {
  @override
  _EmailNewPasscodeState createState() => _EmailNewPasscodeState();
}

class _EmailNewPasscodeState extends State<EmailNewPasscode> {
