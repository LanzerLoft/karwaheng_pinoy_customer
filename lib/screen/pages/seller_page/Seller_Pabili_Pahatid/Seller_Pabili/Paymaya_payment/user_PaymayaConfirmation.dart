...
import '../seller_Pabili.dart';

class UserPabiliPaymayaConfirmation extends StatefulWidget {
  @override
  _UserPabiliPaymayaConfirmationState createState() =>
      _UserPabiliPaymayaConfirmationState();
}

class _UserPabiliPaymayaConfirmationState
    extends State<UserPabiliPaymayaConfirmation> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   pageRoute(context, UserPabiliPaymayaConfirmation());
      // }),
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                alignment: Alignment.center,
                child: sliderButton(() {
                  pageRoute(context, SellerPabiliResponsive());
                }),
              ),
              // SizedBox(
              //   height: 60,
