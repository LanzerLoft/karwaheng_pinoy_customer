...
class SellerPabiliDropInfo extends StatefulWidget {
  @override
  _SellerPabiliDropInfoState createState() => _SellerPabiliDropInfoState();
}

class _SellerPabiliDropInfoState extends State<SellerPabiliDropInfo> {
                  ...
                  Column(
                    children: [
                      addressPickupLocation((value) {},
                          ...
                          () {
                        pageRoute(context, SellerPabiliEnterDropOffMAP());
                      }),
                      Align(
...
class SellerPabiliEnterDropOffMAP extends StatefulWidget {
  @override
  State<SellerPabiliEnterDropOffMAP> createState() =>
      SellerPabiliEnterDropOffMAPState();
}

class SellerPabiliEnterDropOffMAPState
    extends State<SellerPabiliEnterDropOffMAP> {
