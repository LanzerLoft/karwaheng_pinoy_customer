...
class SellerPabiliGCASHPayment extends StatefulWidget {
  @override
  _SellerPabiliGCASHPayment createState() => _SellerPabiliGCASHPayment();
}

class _SellerPabiliGCASHPayment extends State<SellerPabiliGCASHPayment> {
  String selected;
  @override
