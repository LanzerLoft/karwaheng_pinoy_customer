...
class SellerPahatidDropInfo extends StatefulWidget {
  @override
  _SellerPahatidDropInfoState createState() => _SellerPahatidDropInfoState();
}

class _SellerPahatidDropInfoState extends State<SellerPahatidDropInfo> {
                  ...
                  Column(
                    children: [
                      addressPickupLocation((value) {},
                          ...
                          () {
                        pageRoute(context, SellerPahatidEnterDropOffMAP());
                      }),
                      Align(
...
class SellerPahatidEnterDropOffMAP extends StatefulWidget {
  @override
  State<SellerPahatidEnterDropOffMAP> createState() =>
      SellerPahatidEnterDropOffMAPState();
}

class SellerPahatidEnterDropOffMAPState
    extends State<SellerPahatidEnterDropOffMAP> {
