                ...
                Column(
                  children: [
                    addressPickupLocation((value) {},
                        ...
                        () {
                      pageRoute(context, SellerPahatidEnterPickupMAP());
                    }),
                    Align(
...
class SellerPahatidEnterPickupMAP extends StatefulWidget {
  @override
  State<SellerPahatidEnterPickupMAP> createState() =>
      SellerPahatidEnterPickupMAPState();
}

class SellerPahatidEnterPickupMAPState
    extends State<SellerPahatidEnterPickupMAP> {
